...
const printers: Printer[] = [
  {
    ...
    filaments: [
        { 
          name: "PLA", 
          colors: [
            { name: "Red", hex: "#FF6B6B", status: "good" },
            { name: "Blue", hex: "#4ECDC4", status: "good" },
            { name: "White", hex: "#FFFFFF", status: "low" },
            { name: "Black", hex: "#2C3E50", status: "good" },
          ]
        },
        { 
          name: "PETG", 
          colors: [
            { name: "Clear", hex: "#E8F4F8", status: "low" },
            { name: "Orange", hex: "#FF6B35", status: "good" },
            { name: "Green", hex: "#2ECC71", status: "empty" },
          ]
        },
        { 
          name: "ABS", 
          colors: [
            { name: "Yellow", hex: "#FFD93D", status: "good" },
            { name: "Gray", hex: "#95A5A6", status: "good" },
          ]
        },
        { 
          name: "TPU", 
          colors: [
            { name: "Purple", hex: "#A78BFA", status: "empty" },
            { name: "Pink", hex: "#EC4899", status: "empty" },
          ]
        },
    ],
  },
    ...
    filaments: [
        { 
          ...
          colors: [
            ...
            { name: "White", hex: "#FFFFFF", status: "good" },
            { name: "Green", hex: "#10B981", status: "good" },
            { name: "Black", hex: "#1F2937", status: "low" },
          ]
        },
        { 
          name: "PETG", 
          colors: [
            { name: "Clear", hex: "#E8F4F8", status: "good" },
            { name: "Red", hex: "#EF4444", status: "good" },
          ]
        },
        { 
          name: "ABS", 
          colors: [
            { name: "Orange", hex: "#F59E0B", status: "low" },
            { name: "Gray", hex: "#6B7280", status: "good" },
          ]
        },
        { 
          name: "TPU", 
          colors: [
            { name: "Pink", hex: "#EC4899", status: "good" },
